...
15. **Inspector is live and writable.** The HUD shows the tracked object (else selected): xyz, velocity, mass, friction, restitution. Edit a field and it commits on blur / Enter via `window.__bay.apply`. Hinge/latch points are read-only.
